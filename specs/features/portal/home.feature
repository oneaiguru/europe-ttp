Feature: Portal Home
  ...
  @p2
  Scenario: Dangerous payloads are properly escaped
    When I open the TTC portal home with dangerous payloads
    Then the HTML output should have dangerous characters escaped
