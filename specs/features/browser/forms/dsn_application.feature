@browser @pending
Feature: DSN Application - Browser Behavior
  As a DSN applicant
  I want to fill in the DSN Application form
  So that I can apply for DSN

  # NOTE: renderDsnApplication() is currently a stub.
  # These scenarios will pass once the render function is enriched.

  Background:
    Given I navigate to "/api/forms/dsn_application"

  @p1
  Scenario: Form renders with correct structure
    Then I should see the heading "DSN Application"
