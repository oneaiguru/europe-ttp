@browser @pending
Feature: TTC Evaluation - Browser Behavior
  As a TTC evaluator
  I want to fill in the TTC Evaluation form
  So that I can evaluate a TTC applicant

  # NOTE: renderTtcEvaluation() is currently a stub.
  # These scenarios will pass once the render function is enriched.

  Background:
    Given I navigate to "/api/forms/ttc_evaluation"

  @p1
  Scenario: Form renders with correct structure
    Then I should see the heading "TTC Evaluation"
