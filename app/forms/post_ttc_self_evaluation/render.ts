...
export function renderPostTtcSelfEvaluationForm(): string {
  return (
    ...
    '<h1 class="text-2xl font-light text-gray-800 mb-4">Post-TTC Self Evaluation</h1>' +
    `<form id="${FORM_ID}"><span class="form-type hidden">post_ttc_self_evaluation_form</span>` +
    renderFields(FIELDS) +
    renderSubmitButton() +
    '</form>' +
