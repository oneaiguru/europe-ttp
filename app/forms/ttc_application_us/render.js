...
function renderTtcApplicationUsForm() {
    return "<h1>".concat(exports.TTC_APPLICATION_US_FORM_TITLE, "</h1><div id=\"").concat(exports.TTC_APPLICATION_US_FORM_ID, "\">").concat(exports.TTC_APPLICATION_US_QUESTION_MARKER, "</div>");
}
