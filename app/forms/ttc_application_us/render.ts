...
export function renderTtcApplicationUsForm(): string {
  return `<h1>${TTC_APPLICATION_US_FORM_TITLE}</h1><div id="${
    TTC_APPLICATION_US_FORM_ID
  }">${TTC_APPLICATION_US_QUESTION_MARKER}</div>`;
}
