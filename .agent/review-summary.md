Review the summary admin page Tailwind migration.

READ IN FULL:
- app/admin/summary/render.ts (or app/admin/ttc_applicants_summary/render.ts if that exists)
...
If bugs found: fix them and commit with "fix: review correction for summary"
