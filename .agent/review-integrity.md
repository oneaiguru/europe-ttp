Review the integrity admin page Tailwind migration.

READ IN FULL:
- app/admin/integrity/render.ts (or app/admin/ttc_applicants_integrity/render.ts if that exists)
...
If bugs found: fix them and commit with "fix: review correction for integrity"
