// Generated from: ../../specs/features/browser/forms/dsn_application.feature
import { test } from "playwright-bdd";

test.describe('DSN Application - Browser Behavior', () => {

  test.beforeEach('Background', async ({ Given, page }, testInfo) => { if (testInfo.error) return;
    await Given('I navigate to "/api/forms/dsn_application"', null, { page }); 
  });
  
  test('Form renders with correct structure', { tag: ['@browser', '@pending', '@p1'] }, async ({ Then, And, page }) => { 
    await Then('I should see the heading "DSN Application"', null, { page }); 
