// Generated from: ../../specs/features/browser/forms/ttc_application_us.feature
import { test } from "playwright-bdd";

test.describe('TTC Application (US) - Browser Behavior', () => {

  test.beforeEach('Background', async ({ Given, page }, testInfo) => { if (testInfo.error) return;
    await Given('I navigate to "/api/forms/ttc_application_us"', null, { page }); 
  });
