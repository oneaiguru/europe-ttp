// Generated from: ../../specs/features/browser/forms/ttc_application_non_us.feature
import { test } from "playwright-bdd";

test.describe('TTC Application (Non-US) - Browser Behavior', () => {

  test.beforeEach('Background', async ({ Given, page }, testInfo) => { if (testInfo.error) return;
    await Given('I navigate to "/api/forms/ttc_application_non_us"', null, { page }); 
  });
  
  test('Form renders with correct structure', { tag: ['@browser', '@pending', '@p1'] }, async ({ Then, And, page }) => { 
    await Then('I should see the heading "TTC Application"', null, { page }); 
