const STEPS = {
  ...
  "I have NOT completed the Happiness Program": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:23",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:29",
  ...
  "the DSN application form should NOT be available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:33",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:43",
  ...
  "I complete the Happiness Program": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:43",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:53",
  ...
  "the DSN application form should become available": {
    ...
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:67",
  ...
  "I have completed Part 1 but NOT Part 2": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:63",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:83",
  ...
  "the YES+ application form should NOT be available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:73",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:97",
    features: ["specs/features/e2e/form_prerequisites_conditional.feature:16"]
  },
  "I complete Part 2": {
    pattern: /^I\ complete\ Part\ 2$/,
    python: "test/python/steps/form_prerequisites_steps.py:83",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:111",
  ...
  "the YES+ application form should become available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:93",
  ...
  "the Part 1 course application should NOT be available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:103",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:143",
  ...
  "the Part 1 course application should become available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:113",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:157",
  ...
  "I have NOT completed Part 1": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:123",
  ...
  "the Part 2 course application should NOT be available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:133",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:189",
    features: ["specs/features/e2e/form_prerequisites_conditional.feature:30"]
  },
  "I complete Part 1": {
    pattern: /^I\ complete\ Part\ 1$/,
    python: "test/python/steps/form_prerequisites_steps.py:143",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:203",
  ...
  "the Part 2 course application should become available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:153",
  ...
  "my home country is {string}": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:163",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:235",
  ...
  "US-specific TTC options should be available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:173",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:249",
  ...
  "India-specific TTC options should NOT be available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:183",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:263",
  ...
  "I update my home country to {string}": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:193",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:277",
  ...
  "India-specific TTC options should become available": {
    ...
    python: "test/python/steps/form_prerequisites_steps.py:203",
    typescript: "test/typescript/steps/form_prerequisites_steps.ts:291",
