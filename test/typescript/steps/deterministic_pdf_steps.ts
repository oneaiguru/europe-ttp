...
// Module augmentation: correct jsPDF's getCreationDate types to match runtime behavior
// The jsPDF types incorrectly require a string arg and always return Date,
// but at runtime: no args returns PDF date string, 'jsDate' returns Date object.
